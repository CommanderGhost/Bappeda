...
<!-- Isi Data -->
<h5 class="text-center mt-2">Pencarian Data</h5>

<!-- table dropdown -->
<div class="container-fluid row justify-content-center">
<div class="col-md-4">
<label for="exampleFormControlFile1">KATA KUNCI</label>
...
<label for="exampleFormControlFile1">OPD PENGENTRI</label>
<select class="form-control">
  <option>Default select</option>
</select>
<label for="exampleFormControlFile1">ELEMEN</label>
<select class="form-control">
  <option>Default select</option>
</select>
...
<div class="mt-2">
    <button type="submit" class="btn btn-primary btn-secondary">RESET</button>
    <button type="submit" class="btn btn-primary btn-warning">PROSES</button>
</div>
</div>
</div>
<!-- table dropdown -->
