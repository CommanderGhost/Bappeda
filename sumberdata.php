...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb justify-content-center" style="background-color:white">
    <li class="breadcrumb-item"><a href="#">ADMINISTRATOR</a></li>
    <li class="breadcrumb-item active" aria-current="page">SUMBERDATA</li>
  </ol>
</nav>
</div>
<div class="row container-fluid justify-content-center">
  ...
  <button class="btn btn-success my-2 my-sm-0 mx-2" type="submit">Cari Data</button>
  <button class="btn btn-success my-2 my-sm-0 mx-2" type="submit">Tambah</button>
    </form>
  <!-- search form -->
  </div>
  </div>
