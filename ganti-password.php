...
<div class=" d-flex justify-content-center mt-2">
  ...
  <h6 class="text-center"><i>Anda belum melakukan perubahan password</i></h6>
  <h6 class="text-center"><i>Silahkan melakukan perubahan password terlebih dahulu</i></h6>
</div>
      </div>
      </div>
<!-- Alert -->
...
<div class=" d-flex justify-content-center">
  ...
  <div class="form-group">
    ...
    <input type="password" class="form-control" id="password" placeholder="Ulangi Password Baru">
  </div>

  <button type="submit" class="btn btn-warning btn-block"><h6>Masuk</h6></button>  
</form>
</div>
    <div class="card-header bg-success">
