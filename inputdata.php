  ...
  <button type="button" class="btn btn-success">Pilih</button>
         ...
         <td rowspan="7" width="30px"></td>
             <td rowspan="7" valign="top">
                <h5 class="text-center">Kondisi Pendidikan Anak Usia Dini</h5><br>
                 <table border="1">
                 <div class="mb-2">
                      <div class="dropdown">
      <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <button type="button" class="btn btn-warning">Copy Data</button>
        <button type="button" class="btn btn-primary">Proses</button>
        <button type="button" class="btn btn-success">Grafik</button>
        </div>
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    <a class="dropdown-item" href="#">Action</a>
    <a class="dropdown-item" href="#">Another action</a>
